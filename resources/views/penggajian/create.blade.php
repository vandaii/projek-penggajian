<!-- filepath: /c:/xampp/htdocs/projek_gaji/resources/views/penggajian/create.blade.php -->
<x-dashboard-layout>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('penggajian.store') }}">
                        ...
                        <div>
                            ...
                            <select class="block w-full mt-1 rounded-md shadow-sm border-gray-300" name="user_id"
                        ...
                        <div>
                            ...
                            <x-text-input id="gaji_bersih" class="block mt-1 w-full" type="number" name="gaji_bersih"
                                :value="old('gaji_bersih')" readonly />
