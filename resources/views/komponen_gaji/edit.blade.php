<x-dashboard-layout>
    ...
    <div class="w-full flex justify-center translate-y-10">
        <div class="w-4/6 bg-white p-5 shadow-md">
            ...
            <form method="POST" action="{{ route('komponen_gaji.update', $komponen->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <select class="block w-full mt-1 rounded-md shadow-sm border-gray-300" name="user_id" id="user_id">
                        @foreach ($users as $user)
                            <option value="{{ $user->id }}" data-jabatan="{{ $user->jabatan->name }}"
                                ...
                                {{ $user->id == $komponen->user_id ? 'selected' : '' }}>{{ $user->name }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <x-text-input id="gaji_pokok" class="block mt-1 w-full" type="number" name="gaji_pokok"
                        :value="old('gaji_pokok', $komponen->gaji_pokok)" required readonly autofocus autocomplete="gaji_pokok" />
                ...
                <div>
                    ...
                    <x-text-input id="tunjangan" class="block mt-1 w-full" type="number" name="tunjangan"
                        :value="old('tunjangan', $komponen->tunjangan)" required readonly autofocus autocomplete="tunjangan" />
                ...
                <div>
                    ...
                    <x-text-input id="potongan" class="block mt-1 w-full" type="number" name="potongan"
                        :value="old('potongan', $komponen->potongan)" required autofocus autocomplete="potongan" />
                ...
                <div>
                    ...
                    <x-text-input id="pph" class="block mt-1 w-full" type="number" name="pph"
                        :value="old('pph', $komponen->pph)" required autofocus autocomplete="pph" />
                ...
                <div>
                    ...
                    <x-text-input id="bpjs" class="block mt-1 w-full" type="number" name="bpjs"
                        :value="old('bpjs', $komponen->bpjs)" required autofocus autocomplete="bpjs" />
                ...
                <div>
                    ...
                    <x-text-input id="gaji_bersih" class="block mt-1 w-full" type="number" name="gaji_bersih"
                        :value="old('gaji_bersih', $komponen->gaji_bersih)" required readonly autofocus autocomplete="gaji_bersih" />
